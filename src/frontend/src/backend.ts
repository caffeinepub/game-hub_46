...
import type { ExternalBlob as _ExternalBlob, Game as _Game, GameInput as _GameInput, UserProfileView as _UserProfileView, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addComment(arg0: string, arg1: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async createGame(arg0: GameInput): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createGame(await to_candid_GameInput_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getGame(arg0: string): Promise<Game> {
        if (this.processError) {
            try {
                const result = await this.actor.getGame(arg0);
                return from_candid_Game_n16(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getGameComments(arg0: string): Promise<Array<Comment>> {
        if (this.processError) {
            try {
    ...
    async getGameRating(arg0: string): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.getGameRating(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLeaderboard(arg0: bigint): Promise<Array<[Principal, bigint]>> {
        if (this.processError) {
            try {
    ...
    async playGame(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async rateGame(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.rateGame(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateFavorites(arg0: string, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateFavorites(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateGame(arg0: string, arg1: GameInput): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateGame(arg0, await to_candid_GameInput_n10(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Game>): Promise<Array<Game>> {
...
async function to_candid_GameInput_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: GameInput): Promise<_GameInput> {
